...
namespace {
	...
	const char* VERTEX_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_exercise3/shader.vs";
	const char* FRAGMENT_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_exercise3/shader.fs";
}
