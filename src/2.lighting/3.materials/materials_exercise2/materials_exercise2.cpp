/**
 * @file materials_exercise2.cpp
 * @brief Simulating lighting of real-world objects
...
namespace {
	...
	const char* WINDOW_NAME = "Materials: Exercise 2";
	
	// Shaders
	const char* CUBE_VERTEX_SHADER = "src/2.lighting/3.materials/materials_exercise2/cube.vs";
	const char* CUBE_FRAGMENT_SHADER = "src/2.lighting/3.materials/materials_exercise2/cube.fs";
	const char* LIGHT_VERTEX_SHADER = "src/2.lighting/3.materials/materials_exercise2/light.vs";
	const char* LIGHT_FRAGMENT_SHADER = "src/2.lighting/3.materials/materials_exercise2/light.fs";
...
int main(void) {
	...
	objectShader.use();
	// Light intensities must be maximized to properly simulate these real-world color values
	objectShader.setVec3("light.ambient", 1.0f, 1.0f, 1.0f);
	objectShader.setVec3("light.diffuse", 1.0f, 1.0f, 1.0f);
	objectShader.setVec3("light.specular", 1.0f, 1.0f, 1.0f);
	// Gold material colors for the cube object
	...
	objectShader.setFloat("material.shininess", 128.0f * 0.4f); // 40% of 128
	// Cyan plastic material colors for the cube object
	...
	//objectShader.setFloat("material.shininess", 128.0f * 0.25f);
	// Chrome material colors for the cube object
	//objectShader.setVec3("material.ambient", 0.25f, 0.25f, 0.25f);
	//objectShader.setVec3("material.diffuse", 0.4f, 0.4f, 0.4f);
	//objectShader.setVec3("material.specular", 0.774597f, 0.774597f, 0.774597f);
	//objectShader.setFloat("material.shininess", 128.0f * 0.6f);
	// Obsidian material colors for the cube object
	//objectShader.setVec3("material.ambient", 0.05375f, 0.05f, 0.06625f);
	//objectShader.setVec3("material.diffuse", 0.18275f, 0.17f, 0.22525f);
	//objectShader.setVec3("material.specular", 0.332741f, 0.328634f, 0.346435f);
	//objectShader.setFloat("material.shininess", 128.0f * 0.3f);
