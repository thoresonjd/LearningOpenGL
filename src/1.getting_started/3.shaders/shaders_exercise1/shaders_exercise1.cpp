...
const char* V_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_exercise1/vertex.shader";
const char* F_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_exercise1/fragment.shader";
