...
const char* PLANE_FRAG_SHADER = "src/5.advanced_lighting/1.advanced_lighting/plane.fs";
const char* CUBE_VERT_SHADER = "src/5.advanced_lighting/1.advanced_lighting/light.vs";
const char* CUBE_FRAG_SHADER = "src/5.advanced_lighting/1.advanced_lighting/light.fs";
// textures
...
void processInput(GLFWwindow* window) {
	...
	// trigger Blinn-Phong or Phong shading
	if (glfwGetKey(window, GLFW_KEY_B) == GLFW_PRESS && !blinnKeyPressed) {
		blinn = !blinn;
		blinnKeyPressed = true;
		std::cout << (blinn ? "Blinn-" : "") << "Phong shading" << std::endl;
	}
