/**
 * @file geometry_shader_exploding.cpp
 * @brief Rendering an explosion effect via a geometry shader
 * @date July 2023
...
const char* WINDOW_NAME = "Geometry shader: exploding";
// shaders
const char* VERT_SHADER = "src/4.advanced_opengl/8.geometry_shader/geometry_shader_exploding/geometry_shader.vs";
const char* FRAG_SHADER = "src/4.advanced_opengl/8.geometry_shader/geometry_shader_exploding/geometry_shader.fs";
const char* GEOM_SHADER = "src/4.advanced_opengl/8.geometry_shader/geometry_shader_exploding/geometry_shader.gs";
// model
...
int main(void) {
	...
	Shader shader(VERT_SHADER, FRAG_SHADER, GEOM_SHADER);
