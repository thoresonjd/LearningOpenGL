/**
 * @file materials_exercise1.cpp
 * @brief Color of the light source changes along with its respective cube object
...
namespace {
	...
	const char* WINDOW_NAME = "Materials: Exercise 1";
	
	// Shaders
	const char* CUBE_VERTEX_SHADER = "src/2.lighting/3.materials/materials_exercise1/cube.vs";
	const char* CUBE_FRAGMENT_SHADER = "src/2.lighting/3.materials/materials_exercise1/cube.fs";
	const char* LIGHT_VERTEX_SHADER = "src/2.lighting/3.materials/materials_exercise1/light.vs";
	const char* LIGHT_FRAGMENT_SHADER = "src/2.lighting/3.materials/materials_exercise1/light.fs";
