...
namespace {
	...
	// Shaders
	const char* CUBE_VERTEX_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_diffuse_map/cube.vs";
	const char* CUBE_FRAGMENT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_diffuse_map/cube.fs";
	const char* LIGHT_VERTEX_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_diffuse_map/light.vs";
	const char* LIGHT_FRAGMENT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_diffuse_map/light.fs";
