/**
 * @file lighting_maps_exercise2.cpp
 * @brief Inverting color values in fragment shader
 * @date July 2023
...
const char* WINDOW_NAME = "Lighting Maps: exercise 2";
// shaders
const char* CUBE_VERT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise2/cube.vs";
const char* CUBE_FRAG_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise2/cube.fs";
const char* LIGHT_VERT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise2/light.vs";
const char* LIGHT_FRAG_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise2/light.fs";
// textures
