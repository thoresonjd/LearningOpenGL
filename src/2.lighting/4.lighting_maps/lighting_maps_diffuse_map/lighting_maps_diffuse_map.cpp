/**
 * @file lighting_maps_diffuse_map.cpp
 * @brief Using a diffuse map texture to shade a container
 * @date July 2023
...
const char* WINDOW_NAME = "Lighting Maps: diffuse map";
// shaders
const char* CUBE_VERT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_diffuse_map/cube.vs";
const char* CUBE_FRAG_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_diffuse_map/cube.fs";
const char* LIGHT_VERT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_diffuse_map/light.vs";
const char* LIGHT_FRAG_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_diffuse_map/light.fs";
// textures
const char* CONTAINER_TEX = "assets/textures/container2.png";
// camera
...
int main(void) {
	...
	unsigned int diffuseMap = loadTexture(CONTAINER_TEX);
	cubeShader.use();
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// transformations to different spaces
