...
// shaders
const char* CUBE_VERT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_specular/cube.vs";
const char* CUBE_FRAG_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_specular/cube.fs";
const char* LIGHT_VERT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_specular/light.vs";
const char* LIGHT_FRAG_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_specular/light.fs";
// camera
