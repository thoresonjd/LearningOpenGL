/**
 * @file deferred_shading_volumes.cpp
 * @brief Deferred shading using volumes
 * @date September 2023
...
const char* WINDOW_NAME = "Deferred shading: volumes";
// shaders
const char* GEOMETRY_PASS_VERT = "src/5.advanced_lighting/8.deferred_shading/deferred_shading_volumes/g_buffer.vs";
const char* GEOMETRY_PASS_FRAG = "src/5.advanced_lighting/8.deferred_shading/deferred_shading_volumes/g_buffer.fs";
const char* LIGHTING_PASS_VERT = "src/5.advanced_lighting/8.deferred_shading/deferred_shading_volumes/deferred_shading.vs";
const char* LIGHTING_PASS_FRAG = "src/5.advanced_lighting/8.deferred_shading/deferred_shading_volumes/deferred_shading.fs";
const char* LIGHT_BOX_VERT = "src/5.advanced_lighting/8.deferred_shading/deferred_shading_volumes/deferred_light_box.vs";
const char* LIGHT_BOX_FRAG = "src/5.advanced_lighting/8.deferred_shading/deferred_shading_volumes/deferred_light_box.fs";
// models
