...
namespace {
	...
	const char* WINDOW_NAME = "Textures: Exercise 1";
	...
	const char* VERTEX_SHADER_PATH = "src/1.getting_started/4.textures/textures_exercise1/shader.vs";
	const char* FRAGMENT_SHADER_PATH = "src/1.getting_started/4.textures/textures_exercise1/shader.fs";
}
