/**
 * @file lighting_casters_spot_soft.cpp
...
namespace {
	...
	const char* WINDOW_NAME = "Light Casters: Spotlight with Soft Edges";
	
	// Shaders
	const char* CUBE_VERTEX_SHADER = "src/2.lighting/5.light_casters/light_casters_spot_soft/cube.vs";
	const char* CUBE_FRAGMENT_SHADER = "src/2.lighting/5.light_casters/light_casters_spot_soft/cube.fs";
