...
const char* WINDOW_NAME = "Gamma correction";
// shaders
const char* PLANE_VERT_SHADER = "src/5.advanced_lighting/2.gamma_correction/plane.vs";
const char* PLANE_FRAG_SHADER = "src/5.advanced_lighting/2.gamma_correction/plane.fs";
const char* CUBE_VERT_SHADER = "src/5.advanced_lighting/2.gamma_correction/light.vs";
const char* CUBE_FRAG_SHADER = "src/5.advanced_lighting/2.gamma_correction/light.fs";
// textures
...
int main(void) {
	...
	Shader planeShader(PLANE_VERT_SHADER, PLANE_FRAG_SHADER);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		planeShader.setBool("gammaCorrection", gammaCorrection);
		glBindVertexArray(planeVAO);
...
void processInput(GLFWwindow* window) {
	...
	if (glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS)
		lightPos.z -= MOVEMENT_SPEED * deltaTime;
	if (glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS)
		lightPos.z += MOVEMENT_SPEED * deltaTime;
	if (glfwGetKey(window, GLFW_KEY_LEFT) == GLFW_PRESS)
		lightPos.x -= MOVEMENT_SPEED * deltaTime;
	if (glfwGetKey(window, GLFW_KEY_RIGHT) == GLFW_PRESS)
		lightPos.x += MOVEMENT_SPEED * deltaTime;
	if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS)
		lightPos.y += MOVEMENT_SPEED * deltaTime;
