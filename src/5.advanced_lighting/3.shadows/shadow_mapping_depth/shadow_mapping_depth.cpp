...
const char* WINDOW_NAME = "Shadow mapping: depth";
// shaders
const char* DEPTH_VERT_SHADER = "src/5.advanced_lighting/3.shadows/shadow_mapping_depth/shadow_mapping_depth.vs";
const char* DEPTH_FRAG_SHADER = "src/5.advanced_lighting/3.shadows/shadow_mapping_depth/shadow_mapping_depth.fs";
const char* QUAD_VERT_SHADER = "src/5.advanced_lighting/3.shadows/shadow_mapping_depth/quad.vs";
const char* QUAD_FRAG_SHADER = "src/5.advanced_lighting/3.shadows/shadow_mapping_depth/quad.fs";
// textures
