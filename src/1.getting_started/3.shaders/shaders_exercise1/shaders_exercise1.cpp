/**
 * @file shader_exercise1.cpp
 * @brief Flip the triangle upside down
...
namespace {
	...
	const char* WINDOW_NAME = "Shaders: Exercise 1";
	const char* VERTEX_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_exercise1/shader.vs";
	const char* FRAGMENT_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_exercise1/shader.fs";
}
