 ...
 * @brief Invert transformations, translation followed by rotation
 * @date July 2023
...
const char* V_SHADER_PATH = "src/1.getting_started/5.transformations/transformations_exercise1/vertex.shader";
const char* F_SHADER_PATH = "src/1.getting_started/5.transformations/transformations_exercise1/fragment.shader";
