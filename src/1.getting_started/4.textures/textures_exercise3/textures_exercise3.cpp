 ...
 * @brief Zooming in on the textures to see individual texels
 * @date July 2023
...
const char* WINDOW_NAME = "Textures: exercise3";
const std::string V_SHADER_PATH = "src/1.getting_started/4.textures/textures_exercise3/vertex.shader";
const std::string F_SHADER_PATH = "src/1.getting_started/4.textures/textures_exercise3/fragment.shader";
