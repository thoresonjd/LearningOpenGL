/**
 * @file depth_testing_view.cpp
 * @brief Visualizing fragment depth values via colors (black, grey, white)
...
namespace {
	...
	const char* WINDOW_NAME = "Depth Testing: View";

	// Shaders
	const char* VERT_SHADER = "src/4.advanced_opengl/1.depth_testing/depth_testing_view/depth_testing_view.vs";
	const char* FRAG_SHADER = "src/4.advanced_opengl/1.depth_testing/depth_testing_view/depth_testing_view.fs";
