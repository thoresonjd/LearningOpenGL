 ...
 * @brief Camera controlled via keyboard and mouse input
 * @date July 2023
...
// shaders
const char* V_SHADER_PATH = "src/1.getting_started/7.camera/camera_mouse_zoom/vertex.shader";
const char* F_SHADER_PATH = "src/1.getting_started/7.camera/camera_mouse_zoom/fragment.shader";
// textures
...
int main(void) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		projection = glm::perspective(glm::radians(fieldOfView), (float)SCREEN_WIDTH / (float)SCREEN_WIDTH, 0.1f, 100.0f);
