...
namespace {
	...
	const char* VERTEX_SHADER_PATH = "src/1.getting_started/4.textures/textures_combined/shader.vs";
	const char* FRAGMENT_SHADER_PATH = "src/1.getting_started/4.textures/textures_combined/shader.fs";
}
