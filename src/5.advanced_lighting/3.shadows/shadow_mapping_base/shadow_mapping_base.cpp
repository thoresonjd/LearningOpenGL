/**
 * @file shadow_mapping_base.cpp
 * @brief Shadow mapping via depth buffer and framebuffer
 * @date August 2023
...
const char* WINDOW_NAME = "Shadow mapping: base";
// shaders
const char* DEPTH_VERT_SHADER = "src/5.advanced_lighting/3.shadows/shadow_mapping_base/shadow_mapping_depth.vs";
const char* DEPTH_FRAG_SHADER = "src/5.advanced_lighting/3.shadows/shadow_mapping_base/shadow_mapping_depth.fs";
const char* QUAD_VERT_SHADER = "src/5.advanced_lighting/3.shadows/shadow_mapping_base/quad.vs";
const char* QUAD_FRAG_SHADER = "src/5.advanced_lighting/3.shadows/shadow_mapping_base/quad.fs";
const char* SCENE_VERT_SHADER = "src/5.advanced_lighting/3.shadows/shadow_mapping_base/shadow_mapping.vs";
const char* SCENE_FRAG_SHADER = "src/5.advanced_lighting/3.shadows/shadow_mapping_base/shadow_mapping.fs";
// textures
...
int main(void) {
	...
	Shader simpleDepthShader(DEPTH_VERT_SHADER, DEPTH_FRAG_SHADER);
	Shader depthQuadShader(QUAD_VERT_SHADER, QUAD_FRAG_SHADER);
	...
	// texture to use as framebuffer's depth buffer
	...
	while (!glfwWindowShouldClose(window)) {
		...
		depthQuadShader.use();
		depthQuadShader.setFloat("nearPlane", nearPlane);
		depthQuadShader.setFloat("farPlane", farPlane);
		glActiveTexture(GL_TEXTURE0);
		glBindTexture(GL_TEXTURE_2D, depthMap);
		//renderQuad();
