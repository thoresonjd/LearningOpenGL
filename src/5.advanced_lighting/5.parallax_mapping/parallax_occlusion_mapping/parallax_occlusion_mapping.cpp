/**
 * @file parallax_occlusion_mapping.cpp
...
const char* WINDOW_NAME = "Parallax occlusion mapping";
// shaders
const char* VERT_SHADER = "src/5.advanced_lighting/5.parallax_mapping/parallax_occlusion_mapping/parallax_mapping.vs";
const char* FRAG_SHADER = "src/5.advanced_lighting/5.parallax_mapping/parallax_occlusion_mapping/parallax_mapping.fs";
// textures
const char* WOOD_DIFFUSE = "assets/textures/wood.png";
const char* TOY_BOX_NORMAL = "assets/textures/toy_box_normal.png";
const char* TOY_BOX_DISPLACEMENT = "assets/textures/toy_box_disp.png";
// parallax mapping
...
int main(void) {
	...
	// load texture
	unsigned int woodTexture = loadTexture(WOOD_DIFFUSE);
	unsigned int toyBoxBumpMap = loadTexture(TOY_BOX_NORMAL);
	unsigned int toyBoxHeightMap = loadTexture(TOY_BOX_DISPLACEMENT);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glBindTexture(GL_TEXTURE_2D, toyBoxBumpMap);
...
void processInput(GLFWwindow* window) {
	...
	if (glfwGetKey(window, GLFW_KEY_Q) == GLFW_PRESS)
		heightScale = heightScale > 0.0f ? heightScale - 0.0005f : 0.0f;
	if (glfwGetKey(window, GLFW_KEY_E) == GLFW_PRESS)
		heightScale = heightScale < 1.0f ? heightScale + 0.0005f : 1.0f;
}