/**
 * @file lighting_casters_point.cpp
...
namespace {
	...
	const char* WINDOW_NAME = "Light Casters: Point";
	
	// Shaders
	const char* CUBE_VERTEX_SHADER = "src/2.lighting/5.light_casters/light_casters_point/cube.vs";
	const char* CUBE_FRAGMENT_SHADER = "src/2.lighting/5.light_casters/light_casters_point/cube.fs";
	const char* LIGHT_VERTEX_SHADER = "src/2.lighting/5.light_casters/light_casters_point/light.vs";
	const char* LIGHT_FRAGMENT_SHADER = "src/2.lighting/5.light_casters/light_casters_point/light.fs";
