 ...
 * @brief Using a framebuffer with a color texture, depth, and stencil attached
 * @date July 2023
...
const char* WINDOW_NAME = "Framebuffers";
// shaders
const char* OBJECT_VERT_SHADER = "src/4.advanced_opengl/5.framebuffers/framebuffers/framebuffers.vs";
const char* OBJECT_FRAG_SHADER = "src/4.advanced_opengl/5.framebuffers/framebuffers/framebuffers.fs";
const char* SCREEN_VERT_SHADER = "src/4.advanced_opengl/5.framebuffers/framebuffers/framebuffers_screen.vs";
const char* SCREEN_FRAG_SHADER = "src/4.advanced_opengl/5.framebuffers/framebuffers/framebuffers_screen.fs";
// textures
