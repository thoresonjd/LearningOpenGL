...
const char* WINDOW_NAME = "Coordinate Systems: exercise3";
const char* V_SHADER_PATH = "src/1.getting_started/6.coordinate_systems/coordinate_systems_exercise3/vertex.shader";
const char* F_SHADER_PATH = "src/1.getting_started/6.coordinate_systems/coordinate_systems_exercise3/fragment.shader";
...
int main(void) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// create transformations for view and projection
		...
		glBindVertexArray(vao);
		for (int i = 0; i < 10; i++) {
			// create transformation for model
			glm::mat4 model = glm::mat4(1.0f);
			model = glm::translate(model, cubePositions[i]);
			float angle = 20.0f * i;
			if (i % 3 == 0)
				angle += 30.0f * glfwGetTime();
