...
const std::string V_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_exercise1/vertex.shader";
const std::string F_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_exercise1/fragment.shader";
