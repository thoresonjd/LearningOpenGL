...
const char* V_SHADER_PATH = "src/1.getting_started/6.coordinate_systems/coordinate_systems_depth/vertex.shader";
const char* F_SHADER_PATH = "src/1.getting_started/6.coordinate_systems/coordinate_systems_depth/fragment.shader";
