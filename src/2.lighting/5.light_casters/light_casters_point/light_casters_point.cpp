/**
 * @file light_casters_point.cpp
 * @brief Implementing point lighting that fades over distance via attenuation
 * @date July 2023
...
const char* WINDOW_NAME = "Lighting Casters: point lighting";
// shaders
const char* CUBE_VERT_SHADER = "src/2.lighting/5.light_casters/light_casters_point/cube.vs";
const char* CUBE_FRAG_SHADER = "src/2.lighting/5.light_casters/light_casters_point/cube.fs";
const char* LIGHT_VERT_SHADER = "src/2.lighting/5.light_casters/light_casters_point/light.vs";
const char* LIGHT_FRAG_SHADER = "src/2.lighting/5.light_casters/light_casters_point/light.fs";
// textures
