 ...
 * @brief Awesome face repeated over a container clamped to edge
 * @date July 2023
...
const char* WINDOW_NAME = "Textures: exercise2";
const std::string V_SHADER_PATH = "src/1.getting_started/4.textures/textures_exercise2/vertex.shader";
const std::string F_SHADER_PATH = "src/1.getting_started/4.textures/textures_exercise2/fragment.shader";
