/**
 * @file basic_lighting_diffuse.cpp
 * @brief Diffuse Lighting
...
namespace {
	...
	const char* WINDOW_NAME = "Basic Lighting: Diffuse";
	
	// Shaders
	const char* CUBE_VERTEX_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_diffuse/cube.vs";
	const char* CUBE_FRAGMENT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_diffuse/cube.fs";
	const char* LIGHT_VERTEX_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_diffuse/light.vs";
	const char* LIGHT_FRAGMENT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_diffuse/light.fs";
