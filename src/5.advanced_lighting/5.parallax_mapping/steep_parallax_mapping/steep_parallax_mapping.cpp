/**
 * @file steep_parallax_mapping.cpp
...
const char* WINDOW_NAME = "Steep parallax mapping";
// shaders
const char* VERT_SHADER = "src/5.advanced_lighting/5.parallax_mapping/steep_parallax_mapping/parallax_mapping.vs";
const char* FRAG_SHADER = "src/5.advanced_lighting/5.parallax_mapping/steep_parallax_mapping/parallax_mapping.fs";
// textures
