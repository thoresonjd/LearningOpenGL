/**
 * @file textures_exercise1.cpp
 * @brief Rendering two combined textures with one flipped along the x-axis via the fragment shader
 * @date July 2023
...
const char* WINDOW_NAME = "Textures: exercise1";
const std::string V_SHADER_PATH = "src/1.getting_started/4.textures/textures_exercise1/vertex.shader";
const std::string F_SHADER_PATH = "src/1.getting_started/4.textures/textures_exercise1/fragment.shader";
