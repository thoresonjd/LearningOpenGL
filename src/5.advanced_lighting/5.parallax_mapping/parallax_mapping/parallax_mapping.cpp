...
const char* WINDOW_NAME = "Parallax mapping";
// shaders
const char* VERT_SHADER = "src/5.advanced_lighting/5.parallax_mapping/parallax_mapping/parallax_mapping.vs";
const char* FRAG_SHADER = "src/5.advanced_lighting/5.parallax_mapping/parallax_mapping/parallax_mapping.fs";
// textures
const char* BRICKS_DIFFUSE = "assets/textures/bricks2.jpg";
const char* BRICKS_NORMAL = "assets/textures/bricks2_normal.jpg";
const char* BRICKS_DISPLACEMENT = "assets/textures/bricks2_disp.jpg";
// parallax mapping
...
int main(void) {
	...
	// load texture
	unsigned int bricksTexture = loadTexture(BRICKS_DIFFUSE);
	unsigned int bricksBumpMap = loadTexture(BRICKS_NORMAL);
	unsigned int bricksHeightMap = loadTexture(BRICKS_DISPLACEMENT);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glBindTexture(GL_TEXTURE_2D, bricksBumpMap);
