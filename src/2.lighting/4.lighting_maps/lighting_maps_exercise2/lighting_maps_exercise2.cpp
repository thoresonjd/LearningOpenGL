 ...
 * @brief Inverting specular color values in fragment shader
...
namespace {
	...
	// Shaders
	const char* CUBE_VERTEX_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise2/cube.vs";
	const char* CUBE_FRAGMENT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise2/cube.fs";
	const char* LIGHT_VERTEX_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise2/light.vs";
	const char* LIGHT_FRAGMENT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise2/light.fs";
