...
const char* WINDOW_NAME = "Multiple Lights";
// shaders
const char* CUBE_VERT_SHADER = "src/2.lighting/6.multiple_lights/multiple_lights/cube.vs";
const char* CUBE_FRAG_SHADER = "src/2.lighting/6.multiple_lights/multiple_lights/cube.fs";
const char* LIGHT_VERT_SHADER = "src/2.lighting/6.multiple_lights/multiple_lights/light.vs";
const char* LIGHT_FRAG_SHADER = "src/2.lighting/6.multiple_lights/multiple_lights/light.fs";
// textures
...
int main(void) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		for (int i = 0; i < 4; i++) {
			...
			cubeShader.setVec3("pointLights[" + std::to_string(i) + "].ambient", 0.2f, 0.2f, 0.2f);
			cubeShader.setVec3("pointLights[" + std::to_string(i) + "].diffuse", 0.5f, 0.5f, 0.5f);
		...
		// transformations for different spaces
