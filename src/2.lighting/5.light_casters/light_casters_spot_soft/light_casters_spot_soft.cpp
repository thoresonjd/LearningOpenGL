/**
 * @file light_casters_spot_soft.cpp
 * @brief A spotlight with soft edges
 * @date July 2023
...
const char* WINDOW_NAME = "Lighting Casters: spotlight with smooth/soft edges";
// shaders
const char* CUBE_VERT_SHADER = "src/2.lighting/5.light_casters/light_casters_spot_soft/cube.vs";
const char* CUBE_FRAG_SHADER = "src/2.lighting/5.light_casters/light_casters_spot_soft/cube.fs";
const char* LIGHT_VERT_SHADER = "src/2.lighting/5.light_casters/light_casters_spot_soft/light.vs";
const char* LIGHT_FRAG_SHADER = "src/2.lighting/5.light_casters/light_casters_spot_soft/light.fs";
// textures
