/**
 * @file basic_lighting_exercise4.cpp
 * @brief Achieving Gouraud shading by implementing Phong shading in the vertex shader
...
namespace {
	...
	const char* WINDOW_NAME = "Basic Lighting: Exercise 4";
	
	// Shaders
	const char* CUBE_VERTEX_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise4/cube.vs";
	const char* CUBE_FRAGMENT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise4/cube.fs";
	const char* LIGHT_VERTEX_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise4/light.vs";
	const char* LIGHT_FRAGMENT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise4/light.fs";
