/**
 * @file shaders_exercise3.cpp
 * @brief Use vertex position as color
 * @date July 2023
...
const char* WINDOW_NAME = "Shaders: exercise 3";
const std::string V_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_exercise3/vertex.shader";
const std::string F_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_exercise3/fragment.shader";
