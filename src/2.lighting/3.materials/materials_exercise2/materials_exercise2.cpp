 ...
 * @brief Using specified material lighting on the cube object
 * @date July 2023
...
// shaders
const char* CUBE_VERT_SHADER = "src/2.lighting/3.materials/materials_exercise2/cube.vs";
const char* CUBE_FRAG_SHADER = "src/2.lighting/3.materials/materials_exercise2/cube.fs";
const char* LIGHT_VERT_SHADER = "src/2.lighting/3.materials/materials_exercise2/light.vs";
const char* LIGHT_FRAG_SHADER = "src/2.lighting/3.materials/materials_exercise2/light.fs";
// camera
...
int main(void) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		//cubeShader.setFloat("material.shininess", 128.0f * 0.25f);
		...
		//cubeShader.setFloat("material.shininess", 128.0f * 0.6f);
		...
		//cubeShader.setFloat("material.shininess", 128.0f * 0.3f);
