/**
 * @file transformations_exercise1.cpp
 * @brief Reverse transformation order: translation followed by rotation
...
namespace {
	...
	const char* WINDOW_NAME = "Transformations: Exercise 1";
	...
	const char* VERTEX_SHADER_PATH = "src/1.getting_started/5.transformations/transformations_exercise1/shader.vs";
	const char* FRAGMENT_SHADER_PATH = "src/1.getting_started/5.transformations/transformations_exercise1/shader.fs";
}
