...
namespace {
	...
	const char* WINDOW_NAME = "Coordinate Systems";
	...
	const char* VERTEX_SHADER_PATH = "src/1.getting_started/6.coordinate_systems/coordinate_systems/shader.vs";
	const char* FRAGMENT_SHADER_PATH = "src/1.getting_started/6.coordinate_systems/coordinate_systems/shader.fs";
}
...
int main(void) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// draw textured object with transformations and 3D perspective
		// we can technically do all the transformations once outside the render loop
		constexpr glm::mat4 IDENTITY_MATRIX(1.0f);
		glm::mat4 model = glm::rotate(IDENTITY_MATRIX, glm::radians(-55.0f), glm::vec3(1.0f, 0.0f, 0.0f));
