...
const char* V_SHADER_PATH = "src/1.getting_started/6.coordinate_systems/coordinate_systems/vertex.shader";
const char* F_SHADER_PATH = "src/1.getting_started/6.coordinate_systems/coordinate_systems/fragment.shader";
