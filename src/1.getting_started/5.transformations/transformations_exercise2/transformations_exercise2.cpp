...
const char* V_SHADER_PATH = "src/1.getting_started/5.transformations/transformations_exercise2/vertex.shader";
const char* F_SHADER_PATH = "src/1.getting_started/5.transformations/transformations_exercise2/fragment.shader";
...
int main(void) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		trans = glm::mat4(1.0f);
		trans = glm::translate(trans, glm::vec3(-0.5f, 0.5f, 0.0f));
		float scaleVal = static_cast<float>(sin(glfwGetTime()));
