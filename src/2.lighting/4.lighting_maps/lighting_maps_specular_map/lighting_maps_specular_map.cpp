/**
 * @file lighting_maps_specular_map.cpp
 * @brief Using a diffuse and specular map textures to shade a container
 * @date July 2023
...
const char* WINDOW_NAME = "Lighting Maps: specular map";
// shaders
const char* CUBE_VERT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_specular_map/cube.vs";
const char* CUBE_FRAG_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_specular_map/cube.fs";
const char* LIGHT_VERT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_specular_map/light.vs";
const char* LIGHT_FRAG_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_specular_map/light.fs";
// textures
