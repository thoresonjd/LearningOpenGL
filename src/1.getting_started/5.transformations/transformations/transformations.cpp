 ...
 * @brief Applying transformations to rendered textures
...
namespace {
	...
	const char* WINDOW_NAME = "Transformations";
	...
	const char* VERTEX_SHADER_PATH = "src/1.getting_started/5.transformations/transformations/shader.vs";
	const char* FRAGMENT_SHADER_PATH = "src/1.getting_started/5.transformations/transformations/shader.fs";
}
