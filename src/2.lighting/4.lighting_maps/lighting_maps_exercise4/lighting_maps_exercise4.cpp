...
// shaders
const char* CUBE_VERT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise4/cube.vs";
const char* CUBE_FRAG_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise4/cube.fs";
const char* LIGHT_VERT_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise4/light.vs";
const char* LIGHT_FRAG_SHADER = "src/2.lighting/4.lighting_maps/lighting_maps_exercise4/light.fs";
// textures
...
//const char* CONTAINER_EMISSION_MAP = "assets/textures/container2_emission.png"; // By Ellie Scerri http://disq.us/p/2fxldwj
const char* MATRIX_EMISSION_MAP = "assets/textures/matrix.jpg";
// camera
...
int main(void) {
	...
	unsigned int emissionMap = loadTexture(MATRIX_EMISSION_MAP);
	cubeShader.use();
