 ...
 * @brief Camera controlled via keyboard input
 * @date July 2023
...
// shaders
const char* V_SHADER_PATH = "src/1.getting_started/7.camera/camera_keyboard_dt/vertex.shader";
const char* F_SHADER_PATH = "src/1.getting_started/7.camera/camera_keyboard_dt/fragment.shader";
// textures
