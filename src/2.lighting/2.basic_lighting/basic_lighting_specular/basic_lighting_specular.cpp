/**
 * @file basic_lighting_specular.cpp
 * @brief All lighting components of Phong shading model: ambient, diffuse, specular
...
namespace {
	...
	const char* WINDOW_NAME = "Basic Lighting: Specular";
	
	// Shaders
	const char* CUBE_VERTEX_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_specular/cube.vs";
	const char* CUBE_FRAGMENT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_specular/cube.fs";
	const char* LIGHT_VERTEX_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_specular/light.vs";
	const char* LIGHT_FRAGMENT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_specular/light.fs";
