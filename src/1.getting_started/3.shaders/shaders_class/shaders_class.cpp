/**
 * @file shader_class.cpp
 * @brief Using custom shader class to compile shaders
...
namespace {
	...
	const char* WINDOW_NAME = "Shaders: Class";
	const char* VERTEX_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_class/shader.vs";
	const char* FRAGMENT_SHADER_PATH = "src/1.getting_started/3.shaders/shaders_class/shader.fs";
}
