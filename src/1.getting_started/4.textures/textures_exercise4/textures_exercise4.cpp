...
const char* WINDOW_NAME = "Textures: exercise4";
const char* V_SHADER_PATH = "src/1.getting_started/4.textures/textures_exercise4/vertex.shader";
const char* F_SHADER_PATH = "src/1.getting_started/4.textures/textures_exercise4/fragment.shader";
...
int main(void) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glBindTexture(GL_TEXTURE_2D, texture2);	
		shader.use();
		shader.setFloat("mixIntensity", mixIntensity);
		glBindVertexArray(vao);
