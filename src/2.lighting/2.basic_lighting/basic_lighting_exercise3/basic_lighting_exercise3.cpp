 ...
 * @brief Phong shading in view space instead of world space
...
namespace {
	...
	// Shaders
	const char* CUBE_VERTEX_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise3/cube.vs";
	const char* CUBE_FRAGMENT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise3/cube.fs";
	const char* LIGHT_VERTEX_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise3/light.vs";
	const char* LIGHT_FRAGMENT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise3/light.fs";
