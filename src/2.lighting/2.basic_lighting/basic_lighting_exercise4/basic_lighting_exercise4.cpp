/**
 * @file basic_lighting_exercise14.cpp
 * @brief Implementing Phong shading in the vertex shader to achieve Gouraud shading
 * @date July 2023
...
// shaders
const char* CUBE_VERT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise4/cube.vs";
const char* CUBE_FRAG_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise4/cube.fs";
const char* LIGHT_VERT_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise4/light.vs";
const char* LIGHT_FRAG_SHADER = "src/2.lighting/2.basic_lighting/basic_lighting_exercise4/light.fs";
// camera
